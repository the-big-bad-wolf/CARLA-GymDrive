...
class World:
    ...
    def spawn_vehicles_around_ego(
        ...
        self.__traffic_control.spawn_vehicles_around_ego(
            ego_vehicle, radius, num_vehicles_around_ego, seed
        )
    ...
    def spawn_pedestrians_around_ego(
        self, ego_vehicle_location, num_pedestrians=10, radius=50
    ):
        self.__traffic_control.spawn_pedestrians_around_ego(
            ego_vehicle_location, num_pedestrians, radius
        )
    ...
    def place_spectator_above_location(self, location):
        ...
        spectator.set_transform(
            carla.Transform(location + carla.Location(z=50), carla.Rotation(pitch=-90))
        )
    ...
    def place_spectator_behind_location(self, location, rotation):
        ...
        spectator.set_transform(
            carla.Transform(location=spectator_location, rotation=transform.rotation)
        )
